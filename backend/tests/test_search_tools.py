...
class TestCourseSearchTool:
    ...
    def test_execute_successful_lesson_filtered_search(self, mock_search_results):
        ...
        tool = CourseSearchTool(mock_vector_store)
        result = tool.execute(query="data types", course_name="Python Programming", lesson_number=2)
    ...
    def test_execute_empty_results_with_both_filters(self, empty_search_results):
        ...
        tool = CourseSearchTool(mock_vector_store)
        result = tool.execute(query="nonexistent", course_name="Test Course", lesson_number=3)
    ...
    def test_format_results_with_lesson_number(self):
        ...
        search_results = SearchResults(
            ...
            metadata=[{"course_title": "Test Course", "lesson_number": 3, "chunk_index": 0}],
            distances=[0.1]
        )
    ...
    def test_last_sources_reset_between_searches(self, mock_search_results, empty_search_results):
...
class TestToolManager:
    ...
    def test_get_tool_definitions(self):
        ...
        mock_tool1.get_tool_definition.return_value = {"name": "tool1", "description": "First tool"}
        mock_tool2.get_tool_definition.return_value = {"name": "tool2", "description": "Second tool"}
    ...
    def test_get_last_sources_no_search_tools(self):
        ...
        manager = ToolManager()
        mock_tool = Mock(spec=Tool)
        mock_tool.get_tool_definition.return_value = {"name": "non_search_tool", "description": "Test"}
