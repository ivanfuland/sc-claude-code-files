...
class TestRAGSystemInitialization:
    ...
    def test_tool_registration(self, mock_config, mock_components):
        ...
        rag_system.tool_manager.register_tool.assert_called_once_with(rag_system.search_tool)
...
class TestRAGSystemQueryProcessing:
    ...
    def test_query_with_session_id(self, rag_system_with_mocks):
        ...
        response, sources = rag_system_with_mocks.query("Follow up question", session_id)
        
        # Verify conversation history was retrieved
        rag_system_with_mocks.session_manager.get_conversation_history.assert_called_once_with(session_id)
    ...
    def test_query_error_handling(self, rag_system_with_mocks):
        ...
        rag_system_with_mocks.ai_generator.generate_response.side_effect = Exception("AI API Error")
    ...
    def test_query_tool_manager_error(self, rag_system_with_mocks):
        ...
        rag_system_with_mocks.tool_manager.get_last_sources.side_effect = Exception("Tool error")
...
class TestRAGSystemDocumentProcessing:
    ...
    def rag_system_for_docs(self, mock_config, sample_course, sample_course_chunks):
        ...
        with patch('rag_system.DocumentProcessor') as mock_dp, \
            ...
            mock_dp_instance.process_course_document.return_value = (sample_course, sample_course_chunks)
    ...
    def test_add_course_document_success(self, rag_system_for_docs, sample_course, sample_course_chunks):
    ...
    def test_add_course_folder_success(self, rag_system_for_docs, sample_course, sample_course_chunks):
        ...
        with patch('os.path.exists', return_value=True), \
             patch('os.listdir', return_value=["course1.pdf", "course2.txt", "invalid.jpg"]), \
    ...
    def test_add_course_folder_skip_existing_courses(self, rag_system_for_docs, sample_course, sample_course_chunks):
...
class TestRAGSystemIntegration:
    ...
    def real_rag_components(self, mock_config, temp_chroma_dir):
        ...
        with patch('rag_system.DocumentProcessor') as mock_dp, \
            ...
            mock_dp_instance.process_course_document.return_value = (sample_course, sample_chunks)
    ...
    def test_analytics_with_real_data(self, real_rag_components):
        ...
        rag_system.add_course_document("course2.pdf")  # Will be same course, should be skipped
...
class TestRAGSystemEdgeCases:
    ...
    def test_component_initialization_failure(self, mock_config):
        ...
        with patch('rag_system.VectorStore', side_effect=Exception("Vector store init failed")):
